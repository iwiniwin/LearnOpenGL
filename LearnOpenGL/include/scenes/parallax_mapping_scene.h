...
public:
	...
	virtual void init(GLFWwindow* window, float width, float height) {
		...
		shader = new Shader("shaders\\parallax_mapping_scene.vs", "shaders\\parallax_mapping_scene.frag");
		cubeShader = new Shader("shaders\\normal_mapping_scene.vs", "shaders\\single_color_shader.fs");
		diffuseMap = loadTextureFromFile("textures\\bricks2.jpg");
		normalMap = loadTextureFromFile("textures\\bricks2_normal.jpg");
		dispMap = loadTextureFromFile("textures\\bricks2_disp.jpg");
		shader->use();
